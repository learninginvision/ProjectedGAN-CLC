...
@click.option('--data',help='Training data', metavar='[ZIP|DIR]',type=str,default = './data/pokemon224.zip')
...
def main(**kwargs):
    ...
    c.loss_kwargs.clc_loss_type = 'abs'
    c.loss_kwargs.clc_loss_weight = 0.05 # weight for the clc loss
